...
<div class="row">
	<div class="col-xs-12">
		...
		<?php if($movie->poster !=""): ?>
			<a href="./?page=downloadposter&amp;filename=<?= $movie->poster ?>"><img src="./images/poster/300h/<?= $movie->poster ?>" alt="<?= $movie->title ?> poster"></a>
		<?php else: ?>
			...
			<?php foreach ($comments as $comment) : ?>
				...
				<div class="media">
					<div class="media-left">
						<img class="media-object" src="<?= $comment->user()->gravatar(25); ?>" alt="avatar">
					</div>
